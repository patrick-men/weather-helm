...
plt.savefig("/scripts/pics/temperature.png")
...
img.save('/scripts/pics/temperature_description.png')
...
plt.savefig("/scripts/pics/wind.png")
...
img.save('/scripts/pics/wind_description.png')
...
img.save('/scripts/pics/weather_description.png')
